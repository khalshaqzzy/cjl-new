...
const benefits = [
  ...
  {
    icon: Sparkles,
    title: 'Self Service Penuh',
    description: 'Kontrol penuh atas cucian Anda. Pilih mesin dan waktu sesuka hati.',
    size: 'col-span-1',
    accent: false,
  },
  {
    ...
    description: 'Mesin Electrolux berkualitas tinggi dan detergen premium untuk hasil terbaik setiap saat.',
    size: 'sm:col-span-2',
    accent: true,
  },
  {
  ...
  },
  {
    icon: ThumbsUp,
    title: 'Aman & Terang',
    description: 'Tempat bersih dengan CCTV 24 jam.',
    size: 'col-span-1',
    accent: false,
  },
  {
